...
MagicGrid.prototype.positionItems = function positionItems () {
  ...
  var maxHeight = 0;
  var colWidth = this.colWidth();
console.log("Gutter is set to: " + this.gutter); // 현재 gutter 값 확인 내가 추가함ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
...
for (let i = 0; i < masonrys.length; i++) {
    masonrys[i].addEventListener('load', function () {
        console.log("Image loaded, repositioning items."); // 이미지 로드 시 로그 내가 추가함 ㅡㅡㅡㅡㅡㅡㅡㅡ
