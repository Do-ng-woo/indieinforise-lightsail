...
class GenreCreationForm(forms.ModelForm):
    ...
    artist = forms.ModelMultipleChoiceField(queryset=Artist.objects.all(), widget=Select2MultipleWidget(attrs={'class': 'django-select2','style': 'width:100%;'}),required=False)
    beginning_song = forms.ModelMultipleChoiceField(queryset=Sing.objects.all(), widget=Select2MultipleWidget(attrs={'class': 'django-select2','style': 'width:100%;'}),required=False)
    masterpiece_song = forms.ModelMultipleChoiceField(queryset=Sing.objects.all(), widget=Select2MultipleWidget(attrs={'class': 'django-select2','style': 'width:100%;'}),required=False)
    origins = forms.ModelMultipleChoiceField(queryset=Genre.objects.all(), widget=Select2MultipleWidget(attrs={'class': 'django-select2','style': 'width:100%;'}),required=False)
    subgenres = forms.ModelMultipleChoiceField(queryset=Genre.objects.all(), widget=Select2MultipleWidget(attrs={'class': 'django-select2','style': 'width:100%;'}),required=False)
    derived_genres = forms.ModelMultipleChoiceField(queryset=Genre.objects.all(), widget=Select2MultipleWidget(attrs={'class': 'django-select2','style': 'width:100%;'}),required=False)
    related_genres = forms.ModelMultipleChoiceField(queryset=Genre.objects.all(), widget=Select2MultipleWidget(attrs={'class': 'django-select2','style': 'width:100%;'}),required=False)
